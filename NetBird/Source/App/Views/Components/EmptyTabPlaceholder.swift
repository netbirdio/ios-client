    ...
    var body: some View {
        VStack {
            Image("icon-empty-box")
                ...
                .scaledToFit()
                .frame(height: 100)
                .padding(.top, Screen.contentHeight * 0.05)

            Text(message)
                .font(.system(size: 18 * Layout.fontScale, weight: .regular))
                .foregroundColor(Color("TextPrimary"))
                .multilineTextAlignment(.center)
                .padding(.horizontal, Screen.contentWidth * 0.075)
                .padding(.top, Screen.contentHeight * 0.04)
            ...
            if let url = learnMoreURL {
                ...
                .padding(.top, Screen.contentHeight * 0.04)
                .padding(.horizontal, Screen.contentWidth * 0.05)
            }
        }
        .padding(.horizontal, Screen.contentWidth * 0.05)
        .contentColumn()
